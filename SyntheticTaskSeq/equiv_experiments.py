...
def generate_graph_structure(dataset_name, seq_length, non_equiv=False):
    ...
    Modified to accomodate more tasks
    Modified to accomodate non-equivariant baseline
    """
...
def create_datasets(T=1, n_task=None, SAMPLE_NUMBER=2500, vocab_size=13, non_equiv=False):
    """
    ...
    if n_task is not None:
        ...
        structures = [ "palindrome","cyclicsum", "intersect"] #TODO: add more tasks here
        if T == 2:
...
def run_multitask_experiments(r=0.4, T=1, bs=64, trials=1, single=False, 
                              n_task=None, same_bs=False, vocab_size=13, 
