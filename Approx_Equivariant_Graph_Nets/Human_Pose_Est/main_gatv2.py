...
from models.gatv2_model import GATv2Model

def parse_args():
    parser = argparse.ArgumentParser(description='Training script for GINE-based Human Pose Estimation')
...
def main(args):
    ...
    model_pos = GATv2Model(
        n_nodes=dataset.skeleton().num_joints(),
        hid_dim=args.hid_dim,
        perms=perms,
        coords_dim=(2, 3),  # 2D to 3D
